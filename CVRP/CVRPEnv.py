...
class CVRPEnv:
    ...
    def load_problems(self, episode, batch_size, aug_factor=1):
        ...
        if self.mode == 'train':
            ...
            # cluster/expansion/grid/implosion/mixed/uniform
        ...
        self.x_edges, self.x_edges_values, self.x_node_indices, self.x_nodes_false = get_edge_node_problems(self.depot_node_xy, self.num_neighbors, self.knn_node_edge)
        # [B, N+1, N+1]; [B, N+1, K] 
