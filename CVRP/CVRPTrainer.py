...
class CVRPTrainer:
    ...
    def run(self):
        ...
        for epoch in range(self.start_epoch, self.trainer_params['epochs']+1):  
            ...
            if epoch % 100 == 0:
                optimal_reward, score_optimal, Aug_score_optimal, noaug_gap, aug_gap = main_test20(epoch, self.result_folder, cuda_device_num=self.trainer_params['cuda_device_num'])
                save_gap.append([optimal_reward, score_optimal, Aug_score_optimal, noaug_gap, aug_gap])
    ...
    def _train_one_epoch(self, epoch):
        ...
        while episode < train_num_episode:
            ...
            avg_score, avg_loss = self._train_one_batch(episode, batch_size)  
