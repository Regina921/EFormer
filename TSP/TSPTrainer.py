...
class TSPTrainer:
    ...
    def run(self):
        ...
        for epoch in range(self.start_epoch, self.trainer_params['epochs']+1):
            ...
            # test every 50 epoch  
            if epoch % 50 == 0:
                optimal_reward, score_optimal, Aug_score_optimal, gap, aug_gap = main_test50(epoch, self.result_folder,  cuda_device_num=self.trainer_params['cuda_device_num'])
                save_gap.append([optimal_reward, score_optimal, Aug_score_optimal, gap,aug_gap])
