...
tester_params = {
    ...
    'model_load': {
        ...
        'path': './results/model-EFormer/save_tsp100_model_long',
 
        'epoch': 1510,
    },
    'test_episodes': test_paras[TSP][1],   # 65
...
logger_params = {
    'log_file': {
        ...
        'desc': f'{CUDA_DEVICE_NUM}test_K0N{NN}_tsp{TSP}A8',    
...
def main_test100(epoch, path, cuda_device_num=None):
    ...
    optimal_reward, score_optimal, Aug_score_optimal, gap = tester.run()   

    return optimal_reward, score_optimal, Aug_score_optimal, gap
