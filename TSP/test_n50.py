...
logger_params = {
    'log_file': {
        ...
        'desc': f'{CUDA_DEVICE_NUM}test_K0N{NN}_tsp50A8',   
...
def main_test50(epoch, path, cuda_device_num=None):
    ...
    optimal_reward, score_optimal, Aug_score_optimal, gap, aug_gap = tester.run()

    return optimal_reward, score_optimal, Aug_score_optimal, gap, aug_gap
